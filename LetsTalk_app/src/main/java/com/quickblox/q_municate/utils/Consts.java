...
public class Consts {
    ...
    // Q-municate release
    public static final String QB_APP_ID = "38298";
    public static final String QB_AUTH_KEY = "yNmGXVm6jfkWLHX";
    public static final String QB_AUTH_SECRET = "vcjcYOBtpBMhEeS";
